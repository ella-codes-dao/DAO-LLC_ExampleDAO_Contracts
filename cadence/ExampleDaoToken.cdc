...
pub contract ExampleDaoToken: FungibleToken {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun burn(amount: UFix64) {
            pre {
                amount > self.balance: "You cannot burn more tokens than your current balance"
            }
    ...
    pub resource interface AdminPublic {
        ...
        pub fun vote(actionUUID: UInt64, messageSignaturePayload: MessageSignaturePayload)
    }
